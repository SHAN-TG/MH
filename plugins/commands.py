...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, CUSTOM_FILE_CAPTION, BATCH_FILE_CAPTION, PROTECT_CONTENT, SUPPORT_CHAT
    ...
    if message.chat.type in ['group', 'supergroup']:
      ...
      [
        ...
        await message.reply_photo(
            photo="https://telegra.ph/file/ee9637ba7db2cad70e115.jpg",
